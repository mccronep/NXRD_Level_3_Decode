...
ax.plot(xlr,ylr,'ro', label=str(RADAR_3_LETTER), markersize=19)
...
for item in storm_id:
    ...
    # 
    print("The Storm ID is:"+str(storm_id[ii]))   
    ax.text(xlo,ylo, storm_id[ii] ,horizontalalignment='center', verticalalignment='bottom')
    #ax.annotate('a polar annotation', xy=(angl, rng),  xytext=(0.05, 0.05), textcoords='figure fraction', \
    #    arrowprops=dict(facecolor='black', shrink=0.05), \
    #    horizontalalignment='left', \
    #    verticalalignment='bottom')
...
ax.set_extent([cent_lon-2.0, cent_lon+2.0, cent_lat-2.0, cent_lat+2.0])
